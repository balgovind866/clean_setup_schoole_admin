        ...
        <div className='row g-5 mb-7'>
          {[
            ...
            <div className='col-sm-6 col-xl-3' key={label}>
              <div className='card card-flush bg-light-white border-0 h-100'>
                <div className='card-body d-flex align-items-center py-5'>
                  ...
                  <div>
                    <div className={`fs-2 fw-bolder text-gray-900`}>{paymentsLoading ? '—' : value}</div>
...
const CollectionWrapper: FC = () => (
  <>
    <PageTitle breadcrumbs={[{ title: 'Fees', path: '/fees/collection', isActive: false }, { title: 'Invoice Generate', path: '/fees/collection', isActive: true }]}>
